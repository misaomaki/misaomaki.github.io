...
; (function ($) {
    ...
    $.fn.balloon = function (options) {
        ...
        });//.addClass('balloon-target');
    };

    $.fn.unballoon = function () {
        return this.each(function () {
            $(this).removeData().unbind();
        }).removeClass('balloon-target');
    }
    var _showTimer = null;
    $.fn.showBalloon = function (options) {
        ...
        /*if(lastShowBalloon && lastShowBalloon != this) $(lastShowBalloon).hideBalloon();
        lastShowBalloon = this;*/
        return this.each(function () {
            $target = $(this);
            (offTimer = $target.data("offTimer")) && clearTimeout(offTimer);
            var contents = $.isFunction(options.contents)
				? options.contents.call(this)
            ...
            _showTimer = setTimeout(function () {
                ...
                $target.addClass('balloon-target');
                // nixor
                /*
                $('.balloon-target').not($target).each(function () {
                    var $target = $(this);                    
                    $balloon = $target.data("balloon");
                    $balloon && $balloon.stop(true, true).hide();
                }).removeClass('balloon-target');
                */
    ...
    $.fn.hideBalloon = function () {
        ...
        return this.each(function () {
            ...
            $target.data("offTimer", setTimeout(function () {
                ...
                $target.removeClass('balloon-target'); // 9/4 - added by nixor 
            },
			options.minLifetime));
        });
    };
    ...
    $.balloon = {
        defaults: {
            contents: null, url: null, ajaxComplete: null, classname: 'balloon',
